...
$iconPaths = [
    ...
    'table-cells' => 'M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z',
...
$isActive = $active || (request()->routeIs($href) || request()->routeIs($href . '.*'));
@endphp
...
>
    <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $iconPaths[$icon] ?? $iconPaths['home'] }}"/>
    </svg>
    {{ $slot }}
</a>
