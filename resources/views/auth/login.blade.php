        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 p-12 flex-col justify-between relative overflow-hidden">
            ...
            <div class="relative z-10">
                <h1 class="text-4xl font-bold text-white mb-4 leading-tight">
                    Kelola Kelas dengan Lebih Mudah & Modern
                </h1>
                <p class="text-primary-100 text-lg mb-8">
                    Platform digital untuk wali kelas Indonesia. Absensi, pelanggaran, jurnal, dan komunikasi orang tua dalam satu platform.
                </p>
                <div class="space-y-4">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-600">Masuk ke akun Walas Anda</p>
                </div>
                ...
                <!-- Google OAuth -->
                <a href="{{ route('auth.google') }}" class="w-full py-3.5 bg-white border-2 border-gray-200 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 hover:border-gray-300 transition-all flex items-center justify-center gap-3">
